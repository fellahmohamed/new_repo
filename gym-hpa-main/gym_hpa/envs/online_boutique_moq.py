...
class OnlineBoutiqueMOQ(gym.Env):
    ...
    def __init__(self, k8s=False, goal_reward="cost_latency", waiting_period=0.3, objective_weights=[0.5, 0.5]):
        ...
        super(OnlineBoutiqueMOQ, self).__init__()
    ...
    def step(self, action):
        ...
        # For MOQLearning, return vector rewards directly
        # For other algorithms, scalarize if needed
        w1 = 1
        w2 = 1
        ...
        # Return vector rewards for multi-objective RL
