...
def get_env(use_case, k8s, goal):
    ...
    elif use_case == 'online_boutique_mo_Q':
        if goal == 'cost_latency_Q':
            ...
            print(f"✅ Using Multi-Objective Environment for {use_case} with goal {goal}")
        else:
            logging.error('Invalid goal for online_boutique_mo_Q!')
            raise ValueError('Invalid goal for online_boutique_mo_Q!')
    else:
